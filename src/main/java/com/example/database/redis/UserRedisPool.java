...
public class UserRedisPool {
	private static final String defaultMasterHost = "192.168.9.91";
	private static final int defaultPort = 9500;
	private static final int defaultMaxPool = 1000;
	private static final String defaultSlaveHost = "192.168.9.92,192.168.9.93";

	private static final String keyMasterHost = "user_stats.host";
	private static final String keyPort = "user_stats.port";
	private static final String keyMaxPool = "user_stats.max_pool";
	private static final String keySlaveHost = "user_stats.slave";
